      ...
      queue.textChannel
        .send({
          embeds: [
            new MessageEmbed()
              .setColor(ee.color)
              .setImage( `https://cdn.discordapp.com/attachments/1017704325323173898/1017704433993383936/aov-arena-of-valor.gif`
          )
          ...
          case "skip":
            {
              if (!channel) {
                ...
                send(
                  interaction,
                  `** ${emoji.ERROR} คุณต้องเข้าห้องเสียงที่มี Kisara Music **`
                );
              } else if (!queue) {
